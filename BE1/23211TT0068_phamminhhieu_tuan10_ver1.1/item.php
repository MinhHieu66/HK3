...
if (isset($_GET["product_id"])) {
    ...
    $products = $product_Database->getProductsByCategoryId($product["category_id"]);
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="images/<?=$product["image"]?>"
                        alt="..." /></div>
                <div class="col-md-6">
                    ...
                    <form action="buy.php">
                        <div class="d-flex">
                            ...
                            <input class="form-control text-center me-3" id="inputQuantity" type="num" name="quantity"
    ...
    ?>
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <!-- <a href="item.php?product_id=<?=$product["id"]?>"></a> -->
                        <!-- Product details-->
