    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form action="login.html" method="POST">
                <button type="submit"
                    class="btn btn btn-dark me-3 <?=isset($_SESSION["fullname"]) ? 'd-none' : ''?>">Đăng nhập</button>

            </form>

            <form action="processLogout.php" method="POST">
                <button type="submit"
                    class="btn btn btn-dark me-3 <?=empty($_SESSION["fullname"]) ? 'd-none' : ''?>">Đăng xuất</button>
            </form>
...
<h3 class="me-3 <?=isset($_SESSION["fullname"]) ? $_SESSION["fullname"] : 'd-none'?>">
    <?=$_SESSION["fullname"] ?? ""?></h3>