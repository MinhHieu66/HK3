            ...
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
                        <a href="item.php?product_id=<?=$product["id"]?>"><img class="card-img-top"
                                src="images/<?=$product["image"]?>" alt="..." /></a>
                        <!-- Product details-->
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto"
                                    href="buy.php?product_id=<?=$product["id"]?>&quantity=1">Add To Cart</a>
                            </div>
                        </div>
                    </div>
                </div>
...
if (isset($_GET["category_id"])) {
    ...
    <ul class="pagination">
        <?php echo $product_Database->nagivationBar($url, $page, $perPage, $total) ?>
    </ul>
    <!-- Footer-->
